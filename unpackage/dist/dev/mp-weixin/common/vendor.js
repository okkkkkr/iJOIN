...
// 模拟官方登录
var officialLogin = function officialLogin(data) {
  return _request.default.baseRequest({
    url: '/sponsor/login',
    method: 'POST',
    data: data });
...
/***/ 18:
/*!********************************************!*\
  !*** G:/uni-app/iJoin_ui/utils/request.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var baseUrl = 'http://localhost:3000/api';

var baseRequest = function baseRequest(target) {
  var baseDefault = {
    // 请求的接口地址
  ...
  var promise = new Promise(function (resolve, reject) {
    uni.request(baseDefault).then(function (res) {
...
// 获取父亲导航
var getParentNavList = function getParentNavList() {
  return _request.default.baseRequest({
    url: '',
    method: 'GET' });
...
// 获取子类导航
var getChildrenNav = function getChildrenNav(data) {
  console.log("NavList request --------->", data);
  return _request.default.baseRequest({
    url: "/organize/getAllType/".concat(data),
    method: 'GET' });
...
// 获取学号
var getStuNo = function getStuNo(data) {
  return _request.default.baseRequest({
...
// 获取主办方信息
var getSponsorInfo = function getSponsorInfo(data) {
  return _request.default.baseRequest({
...
// 修改主办方信息
var setSponsorInfo = function setSponsorInfo(data) {
  return _request.default.baseRequest({
...

{
  ...
  setSponsorInfo: setSponsorInfo };exports.default = _default;
